...
## 3. 게시 이력 (2026-08-30 기준: 캠페인 글 라이브 16건 + 에릭 자료노트 기본 글 4건)

### 에릭 자료노트 (eric.dothome.co.kr, 워드프레스)

| 발행일 | 제목 | URL | 세일즈 키워드 |
|---|---|---|---|
| 2026-08-19 | 방송통신대 중간과제물, 참고자료 어디서 찾을까? (2026 최신 가이드) | https://eric.dothome.co.kr/knou-gwajemul/ | 기본 홍보코드(redfoxkiller) + 올레포트 검색(sid=leesk55). 원문 미보관(8/30 추가 블록만 보관). **8/30 보강(A6)**: 2학기 확정 일정 섹션 + '함께 보면 좋은 글' 추가 |
| 2026-08-30 | 방통대 사회복지학과·유아교육과 2학기 중간과제물 준비 — 과목별 참고자료와 작성 포인트 (2026) | https://eric.dothome.co.kr/knou-social-welfare-early-childhood-2026-2/ | 사회복지실천론·조사론·정책론 과제물 / 아동관찰및행동연구 과제물 / 유아교육 과제물 (5개, **검색결과 미검증** — 클릭 확인 필요) |
...
- **2026-08-30 (3차, 5부)**: 에릭 자료노트에 방통대 A2 글 발행(https://eric.dothome.co.kr/knou-social-welfare-early-childhood-2026-2/) + 8/19 가이드 글에 확정 일정 섹션·관련 글 링크 추가(A6). 세일즈 링크 5개는 검색결과 미검증(사용자 클릭 확인 대기)
