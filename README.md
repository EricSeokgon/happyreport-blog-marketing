...
| [drafts/](drafts/README.md) | 발행 전 초안 (방통대 3건, 독학사 2건, 병원 보강 5건) — 발행 후 posts_*.html로 이관 |
...
## 3. 게시 이력 (2026-08-29 기준, 총 14건 발행)

### 오후의레포트 (hadeslee, 워드프레스)

| 발행일 | 제목 | URL | 세일즈 키워드 |
|---|---|---|---|
| 2026-08-17 | 상수도관망시설운영관리사 1급·2급 필기 기출 220문항 (2026) | http://hadeslee.dothome.co.kr/?p=14791 | 상수도관망시설운영관리사 |
| 2026-08-17 | 컴플라이언스 오피서(은행) CBCO 필기 기출 210문항 | http://hadeslee.dothome.co.kr/?p=14793 | 컴플라이언스 오피서 |
| 2026-08-17 | 독학사 4단계 대비 전공별 기출 족보 총정리 | http://hadeslee.dothome.co.kr/?p=14795 | 독학사+과목명 8종 |
...
> 원문 HTML은 posts_*.html 파일 참조 (재발행·수정 시 복사용). eric 8/18~19 발행분 5건은 2026-08-29에 라이브 게시글에서 복원한 것.

## 4. 다음 작업 (요약 — 상세는 [docs/ROADMAP.md](docs/ROADMAP.md))

- **P1 (지금~9/10)**: 방통대 2학기 중간과제물 시즌(제출 10/2~10/12) — 키워드 검증 → BEST-100 재분석 → `drafts/2026-09-knou/` 초안 3건 발행 (hadesyi 방송통신 게시판·hadeslee·eric). 후보·링크는 [docs/BACKLOG.md](docs/BACKLOG.md) A
- **P2 (9/7 → 9/22~29 → 11/1)**: 독학사 3단계 발표 직후 hadeslee 글 패치(`drafts/2026-09-dokhaksa/B1`), 4단계 접수 D-7 신규 글(`B2`), 시험 D-15 리마인드
